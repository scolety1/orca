...
export async function handleChatRoute(
  ...
  if (req.method === 'POST') {
    ...
    // Non-execution gate: checked after project scope resolution but
    // strictly before intent classification or any live-action result.
    if (await gateDogfoodChatTurn(json, res, message, project?.id ?? null, body.route)) {
      return true
    }
