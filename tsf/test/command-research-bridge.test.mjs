...
// Shared with command-research-bridge-context.test.mjs -- see that
// module's own header for why the fixtures live there, not duplicated in
// both files (AGENTS.md's own max-lines ceiling forced this split).
const {
  CLOCK: clock,
  cleanupStateFile,
  donorMissionWithCanonicalFact,
  fieldSpec,
  freshOpState,
  persistCommandTurn,
  universe
