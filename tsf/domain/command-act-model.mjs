...
import { VERB_REGISTRY } from './command-act-model-verb-registry.mjs'
...
// which act. VERB_REGISTRY itself lives in command-act-model-verb-
// registry.mjs, purely to stay under this repo's max-lines budget.
// ============================================================================
